...
function combatHelp(c){const u=UPGRADES.find(u=>u.id===c.upgrades?.[c.face]),type=c.faces[c.face][0];
 if(!u&&!['actions','retournement'].includes(type))return '';
