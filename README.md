...
Version jouable : **v0.2.1**. Hébergée sur GitHub Pages.

Mobile-first browser pirate combat prototype. English UI, Flibuste Pop art direction.

## GitHub Pages

GitHub Pages is enabled with GitHub Actions. To republish manually, open **Actions → Publish game to GitHub Pages → Run workflow** on `main`.
